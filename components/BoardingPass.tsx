    ...
    <div className="w-full max-w-2xl bg-white dark:bg-slate-800 rounded-[32px] shadow-ios hover:shadow-ios-lg border border-slate-100/50 dark:border-slate-700 overflow-hidden flex flex-col md:flex-row mb-6 transition-all duration-500">
      <div className="flex-1 p-8 relative">
        <div className="flex justify-between items-start mb-8 border-b border-slate-50 dark:border-slate-700 pb-6">
           <div className="flex items-center gap-4">
             ...
             <div>
               ...
               <div className="font-black text-xl text-slate-900 dark:text-white leading-tight">{segment.airlineNameZh || segment.airline}</div>
             </div>
           </div>
        ...
        <div className="flex justify-between items-center mb-10 px-2">
           <div className="text-left">
              ...
              <div className="text-[10px] font-black text-slate-400 dark:text-slate-500 mt-1 uppercase tracking-widest">{DateTimeUtils.formatDateFriendly(segment.departureTime)}</div>
           </div>
           ...
           <div className="text-right">
              ...
              <div className="text-[10px] font-black text-slate-400 dark:text-slate-500 mt-1 uppercase tracking-widest">{DateTimeUtils.formatDateFriendly(segment.arrivalTime)}</div>
           </div>
        </div>
      ...
      <div className="hidden md:flex w-60 border-l border-dashed border-slate-100 dark:border-slate-700 bg-slate-50/20 dark:bg-slate-900/30 p-8 flex-col justify-between relative transition-colors">
         ...
         <div className="space-y-8">
            <div className="flex items-center gap-2"><span className="font-black text-xs text-slate-400 dark:text-slate-500 tracking-widest truncate">{segment.airlineNameZh || segment.airline}</span></div>
