...
export const translations = {
  zh: {
    ...
    addSegment: "新增航段",
    layover: "轉機",
    layoverAt: "於 {airport} 轉機",
    deleteSegment: "刪除此航段",
    addSegmentBtn: "+ 新增轉機航段",
    addInboundFlight: "新增回程機票",
    removeInboundFlight: "移除回程機票",
    edit: "編輯",
    required: "必填",
  ...
  en: {
    ...
    layover: "Layover",
    layoverAt: "Layover at {airport}",
    deleteSegment: "Delete Segment",
    addSegmentBtn: "+ Add Layover Segment",
    addInboundFlight: "Add Return Flight",
    removeInboundFlight: "Remove Return Flight",
    edit: "Edit",
    required: "Required",
